  ...
  if($_POST){
	  ...
	  if($num>0){
		  ...
		  if($password_bd == $pass_c){
			  ...
			  echo "La conrtaseña no coincide";
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" name="usuario" type="text" placeholder="Introduce tu correo" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">contraseña</label>
                                                <input class="form-control py-4" id="inputPassword" name="password" type="password" placeholder="Introduce tu contraseña" />
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="register.html">Necesitas una cuenta? Da click aqui</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
